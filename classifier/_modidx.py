...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'classifier.chroma': { 'classifier.chroma.get_or_make_chroma': ('chroma.html#get_or_make_chroma', 'classifier/chroma.py'),
            ...
            'classifier.experiments.retrieval_filtering': { 'classifier.experiments.retrieval_filtering.format_filtered_examples': ( 'experiments/10k_retrieval_filtering.html#format_filtered_examples',
