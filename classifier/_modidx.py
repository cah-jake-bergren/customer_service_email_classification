...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'classifier.chroma': { 'classifier.chroma.get_or_make_chroma': ('chroma.html#get_or_make_chroma', 'classifier/chroma.py'),
            ...
            'classifier.experiments.retrieval_filtering': { 'classifier.experiments.retrieval_filtering.get_label_filtered_documents': ( 'experiments/10k_retrieval_filtering.html#get_label_filtered_documents',
